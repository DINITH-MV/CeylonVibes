...
const AcceptedSlips = () => {
  ...
  //       await axios.delete(`http://localhost:5017/slips/${slip._id}`);
  //     }
        ...
        <Card>
          <CardHeader variant="gradient" color="gray" className="mb-8 p-8">
            <Typography variant="h5" color="white">             
              MANAGE ACCEPTED SLIPS
            </Typography>
          </CardHeader>
          <CardBody className="overflow-x-scroll px-0 pt-0 pb-2 mx-[60px]">
    <div className="accept mx-[20px]">
      <div className='bg-[#DAF7A6]'>
        <br/><div className="mt-[10px] ml-[300px] font-Spirax absolute text-[30pt] ">
          Accepted Slips
        </div>
        <div className="">
          <div
